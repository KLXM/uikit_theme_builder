...
class ColorsWidget extends AbstractWidget
{
    ...
    /**
     * Rendert einen modernen Color Picker mit Pickr (Überschreibt AbstractWidget Methode)
     */
    protected function renderColorPicker(string $name, string $value = '#000000', array $attributes = []): string
    {
        ...
        $html .= '<div class="' . $id . '" style="width: 40px; height: 40px; border-radius: 4px; border: 2px solid #e5e5e5; cursor: pointer; background-color: ' . rex_escape($value) . ';"></div>';
        $html .= '</div>';
        ...
        // Individuelle Picker-Initialisierung mit eindeutiger ID
        $html .= '
        <script>
        (function() {
