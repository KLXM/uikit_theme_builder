...
/**
 * API Endpoint für den Live Theme Editor: laufende Live-Session beenden ("Live schalten"-
 * Checkbox im Editor wieder ausgeschaltet). Entfernt das Aktiv-Flag (boot.php injiziert den
 * Public-Listener danach nicht mehr) und die Public-Datei. Nur Admins.
 */
